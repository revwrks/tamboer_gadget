import{B as s,o as e,c as r,p as g,m as t,q as i,l as c,k as l,n as d,a as p,t as u}from"./app.nOLxvhWu.js";var y=function(o){var n=o.dt;return`
.p-tag {
    display: inline-flex;
    align-items: center;
...
`)},m={root:function(o){var n=o.props;return["p-tag p-component",{"p-tag-info":n.severity==="info","p-tag-success":n.severity==="success","p-tag-warn":n.severity==="warn","p-tag-danger":n.severity==="danger","p-tag-secondary":n.severity==="secondary","p-tag-contrast":n.severity==="contrast","p-tag-rounded":n.rounded}]},icon:"p-tag-icon",label:"p-tag-label"},b=s.extend({name:"tag",theme:y,classes:m}),f={name:"BaseTag",extends:d,props:{value:null,severity:null,rounded:Boolean,icon:String},style:b,provide:function(){return{$pcTag:this,$parentInstance:this}}},k={name:"Tag",extends:f,inheritAttrs:!1};function v(a,o,n,h,$,w){return e(),r("span",t({class:a.cx("root")},a.ptmi("root")),[a.$slots.icon?(e(),g(i(a.$slots.icon),t({key:0,class:a.cx("icon")},a.ptm("icon")),null,16,["class"])):a.icon?(e(),r("span",t({key:1,class:[a.cx("icon"),a.icon]},a.ptm("icon")),null,16)):c("",!0),a.value!=null||a.$slots.default?l(a.$slots,"default",{key:2},function(){return[p("span",t({class:a.cx("label")},a.ptm("label")),u(a.value),17)]}):c("",!0)],16)}k.render=v;export{k as s};
