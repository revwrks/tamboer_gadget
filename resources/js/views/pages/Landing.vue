        ...
        <div id="home" class="landing-wrapper overflow-hidden">
            ...
            >
                ...
                <div class="flex justify-center md:justify-end">
                    <img src="/public/demo/images/landing/screen-1.png" alt="Hero Image" class="w-9/12 md:w-auto" />
                </div>
            </div>
                ...
                <div class="grid grid-cols-12 gap-4 justify-center">
                    ...
                    >
                        <div class="flex flex-col justify-center items-center text-center px-4 py-4 md:py-0">
                            ...
                            <img src="/public/demo/images/landing/peak-logo.svg" class="mt-6" alt="Company logo" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="highlights" class="py-6 px-6 lg:px-20 mx-0 my-12 lg:mx-20">
                ...
                <div class="grid grid-cols-12 gap-4 mt-20 pb-2 md:pb-20">
                    <div class="flex justify-center col-span-12 lg:col-span-6 bg-purple-100 p-0 order-1 lg:order-none" style="border-radius: 8px">
                        <img src="/public/demo/images/landing/mockup.svg" class="w-11/12" alt="mockup mobile" />
                    </div>
                ...
                <div class="grid grid-cols-12 gap-4 my-20 pt-2 md:pt-20">
                    ...
                    <div class="flex justify-end order-1 sm:order-2 col-span-12 lg:col-span-6 bg-yellow-100 p-0" style="border-radius: 8px">
                        <img src="/public/demo/images/landing/mockup-desktop.svg" class="w-11/12" alt="mockup" />
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-12 gap-4 justify-between mt-20 md:mt-0">
                    <div class="col-span-12 lg:col-span-4 p-0 md:p-4">
                        <div class="p-4 flex flex-col border-surface-200 dark:border-surface-600 pricing-card cursor-pointer border-2 hover:border-primary duration-300 transition-all" style="border-radius: 10px">
                            ...
                            <img src="/public/demo/images/landing/free.svg" class="w-10/12 mx-auto" alt="free" />
                    ...
                    <div class="col-span-12 lg:col-span-4 p-0 md:p-4 mt-6 md:mt-0">
                        <div class="p-4 flex flex-col border-surface-200 dark:border-surface-600 pricing-card cursor-pointer border-2 hover:border-primary duration-300 transition-all" style="border-radius: 10px">
                            ...
                            <img src="/public/demo/images/landing/startup.svg" class="w-10/12 mx-auto" alt="startup" />
                            <div class="my-8 flex flex-col items-center gap-4">
                                <div class="flex items-center">
                    ...
                    <div class="col-span-12 lg:col-span-4 p-0 md:p-4 mt-6 md:mt-0">
                        <div class="p-4 flex flex-col border-surface-200 dark:border-surface-600 pricing-card cursor-pointer border-2 hover:border-primary duration-300 transition-all" style="border-radius: 10px">
                            ...
                            <img src="/public/demo/images/landing/enterprise.svg" class="w-10/12 mx-auto" alt="enterprise" />
                            <div class="my-8 flex flex-col items-center gap-4">
                                <div class="flex items-center">
                    ...
                    <div class="col-span-12 md:col-span-10">
                        <div class="grid grid-cols-12 gap-8 text-center md:text-left">
                            ...
                            <div class="col-span-12 md:col-span-3">
                                ...
                                <a class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 dark:text-surface-100">Events<img src="/public/demo/images/landing/new-badge.svg" class="ml-2" /></a>
